...
class School(models.Model):
    ...
    SCHOOL_TYPE = {("Public" , "Public"), ("Public", "Private")}
    ...
    circuit_name = models.CharField(
        max_length=20, choices=CIRCUIT_NAME, default="Adjiringanor")
    siso_name = models.CharField(
        max_length=50, choices=CIRCUIT_SISO, default="Florence Kushitor")
    level = models.CharField("School Level", max_length=15,choices=LEVEL, default="KG")
    school_type = models.CharField(
        "School Type", max_length=10, choices=SCHOOL_TYPE, default="Public")
